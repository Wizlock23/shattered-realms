/* Shattered Realms v0.10.1 — approved reference match */
(()=>{
  ...
  function post(){const v=active();document.body.dataset.view=v;patchNav();updateHud();if(v==='adventure')decorateAdventure();if(v==='collection')decorateCollection();if(v==='decks')decorateDecks();if(v==='play')decoratePlay();go(document)}
