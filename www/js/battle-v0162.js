...
/* Shattered Realms v0.16.2 — Battle HUD synchronizer */
(()=>{
  ...
  function forceHostFullscreen(){
    let wide=hostWidth()>=901;
    document.documentElement.classList.toggle('sr162-desktop',wide);
    document.body.classList.toggle('sr162-desktop',wide);
