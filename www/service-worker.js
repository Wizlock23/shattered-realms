...
const CACHE_NAME='shattered-realms-v0.18.0';
const CRITICAL=[
  './','./index.html','./build.json','./manifest.webmanifest','./battle/index.html','./battle/index-v0180.html',
