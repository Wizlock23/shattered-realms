const CACHE_NAME='shattered-realms-v0.15.1';
const CORE = [
  './','./index.html','./manifest.webmanifest','./battle/index.html','./battle/index-v0151.html',
  './css/app-v0151.css','./css/battle-v0151.css',
  './js/sound.js','./js/pwa-install.js','./js/mobile-shell.js','./js/game-data-v0133.js','./js/app.js','./js/ui-v0120.js','./js/engagement-v0130.js','./js/battle-core-v0151.js','./js/battle-v0151.js','./js/battle-engagement-v0130.js',
...
self.addEventListener('fetch', event => {
  ...
  if (req.mode === 'navigate') {
    const fallback = url.pathname.includes('/battle/') ? './battle/index-v0151.html' : './index.html';
