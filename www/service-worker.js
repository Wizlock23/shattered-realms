...
const CACHE_NAME='shattered-realms-v0.18.6';
const CRITICAL=[
  './','./index.html','./build.json','./manifest.webmanifest','./battle/index.html','./battle/index-v0186.html',
