...
const CACHE_NAME='shattered-realms-v0.17.9';
const CRITICAL=[
  './','./index.html','./build.json','./manifest.webmanifest','./battle/index.html','./battle/index-v0179.html',
