...
const CACHE_NAME='shattered-realms-v0.17.4';
const CRITICAL=[
  './','./index.html','./build.json','./manifest.webmanifest','./battle/index.html','./battle/index-v0174.html',
  './css/app-v0166.css','./js/app.js','./js/mobile-shell.js','./js/pwa-install-v0174.js','./js/game-data-v0133.js'
];
const OPTIONAL=[
