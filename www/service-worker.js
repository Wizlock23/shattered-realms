...
const CACHE_NAME='shattered-realms-v0.17.3';
const CRITICAL=[
  './','./index.html','./build.json','./manifest.webmanifest','./battle/index.html','./battle/index-v0173.html',
  './css/app-v0166.css','./js/app.js','./js/mobile-shell.js','./js/pwa-install-v0173.js','./js/game-data-v0133.js'
];
const OPTIONAL=[
