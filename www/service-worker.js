const CACHE_NAME='shattered-realms-v0.16.0';
const CORE = [
  './','./index.html','./manifest.webmanifest','./battle/index.html','./battle/index-v0160.html',
  './css/app-v0151.css','./css/battle-v0160.css',
  './js/sound.js','./js/pwa-install.js','./js/mobile-shell.js','./js/game-data-v0133.js','./js/app.js','./js/ui-v0120.js','./js/engagement-v0130.js','./js/battle-core-v0160.js','./js/battle-v0160.js','./js/battle-engagement-v0130.js',
  ...
  './assets/ui/home-hero-target-v094.jpg','./assets/ui/eryndor-map-concept-v092.jpg','./assets/ui/battle-arena-v0160.jpg',
...
self.addEventListener('fetch', event => {
  ...
  if (req.mode === 'navigate') {
    const fallback = url.pathname.includes('/battle/') ? './battle/index-v0160.html' : './index.html';
