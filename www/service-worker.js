const CACHE_NAME='shattered-realms-v0.14.1';
const CORE = [
  './','./index.html','./manifest.webmanifest','./battle/index.html','./battle/index-v0141.html',
  './css/app-v0136.css','./css/battle-v0141.css',
  './js/sound.js','./js/pwa-install.js','./js/mobile-shell.js','./js/game-data-v0133.js','./js/app.js','./js/ui-v0120.js','./js/engagement-v0130.js','./js/battle-core-v0141.js','./js/battle-v0141.js','./js/battle-engagement-v0130.js',
...
self.addEventListener('fetch', event => {
  ...
  if (req.mode === 'navigate') {
    const fallback = url.pathname.includes('/battle/') ? './battle/index-v0141.html' : './index.html';
